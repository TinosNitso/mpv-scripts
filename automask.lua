...
function property_handler(property,val)
    ...
    if property~= 'path' then return end --path_handler BELOW.
...
----BUG: hwdec MAY CAUSE BAD PERFORMANCE OR ELSE BUG OUT. FFMPEG CAN'T CONVERT PROPERLY BTWN FORMATS INSIDE graph.
