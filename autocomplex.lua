...
function file_loaded()   --ALSO @on_toggle & @timers.file_loaded.
    ...
    a_id,v             = p['current-tracks/audio/id'],p['current-tracks/video'] or {} 
