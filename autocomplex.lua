...
o={ --options  ALL OPTIONAL & MAY BE REMOVED.   TO REMOVE AN INTERNAL COMPONENT SET ITS alpha TO 0 (freqs volume grid feet shoe).
    ...
    highpass  =100, --DEFAULT=100 Hz  DAMPENS SUB-BASS & DC, NEAR volume BAR. 100 Hz FOR BASS HEAVY TRACKS. highpass & dynaudnorm APPLY ONLY TO VISUALS, NOT [ao].  firequalizer COULD ENABLE MULTIPLICATION BY FREQUENCY. A CHIRP MAY BECOME DEAFENING @DOUBLE FREQUENCY. highpass ISN'T THE RIGHT FILTER.
    ...
    -- freqs_framerate =  25, --UNCOMMENT FOR INTERPOLATION (freqs_fade). ADDS ~7% CPU USAGE. FOR albumart CAN REDUCE freqs_fps_image.  NICE LIGHTNING EFFECT BUT LOOKS JITTERY & MAY CAUSE STUTTER @autocrop (WITHOUT DRIVERS).
    ...
    volume_dm          =   0, --DEFAULT=  0  0 OR 1. 1 FOR DISPLAYMAX LINES (RED). 
