...
local options={ --ALL OPTIONAL & MAY BE REMOVED. TO REMOVE A COMPONENT SET ITS alpha TO 0 (freqs, volume & feet).
    ...
    -- final_colormix='gb=1:bb=0', --UNCOMMENT FOR GREEN & RED, INSTEAD OF BLUE & RED (DEFAULT). E.G.: PLAIN WHITE:'gb=1:gr=1:rb=1:br=1'   BLUE, DARKBLUE & BLACK ARE COMPATIBLE WITH cropdetect (autocrop), BUT RED TIPS MAY INTERFERE WHEN BLACK BARS ARE GREY.
    ...
    freqs_highpass     =   10, --DEFAULT= 10 Hz. DAMPENS SUB-BASS & DC, IN THE MIDDLE.
    ...
    volume_height      =   .2, --DEFAULT= .2, RANGE (0,1]. HEIGHT OF BAR (BEFORE STACKING FEET), RELATIVE TO SCREEN. autocrop MAY MAGNIFY ITS SIZE, BY ACCIDENT. MOVING THE BAR UPWARD WOULD TAKE CENTER STAGE (THE NOSE MIGHT BE DEAD-CENTER).
