...
----ACCURATE 100Hz GRID (LEFT 1kHz TO RIGHT 1kHz). ARBITRARY SINE WAVES CAN BE ADDED FOR CALIBRATION & DECORATION. MOVES & ROTATES WITH TIME.  CHANGING TRACKS IN SMPLAYER REQUIRES STOP & PLAY (aid vid LOCK BUG). A SINGER'S VOICE *CAN* GO OVER 1kHz (PRIMARY), SO A FUTURE DESIGN COULD GO TO 11...
...
options={ --ALL OPTIONAL & MAY BE REMOVED. TO REMOVE A COMPONENT SET ITS alpha TO 0 (freqs, volume & feet).
    ...
    format   ='yuv420p',  --DEFAULT=yuv420p  IMPROVES PERFORMANCE. 420p LIMITS COLOR RESOLUTION TO HALF-WIDTH & HALF-HEIGHT.
...
----anull,anullsrc,anullsink    anull FOR TOGGLE OFF.
...
----MPV CURRENTLY HAS A 10 HOUR BACKWARDS SEEK BUG (BUFFER ISSUE?).
