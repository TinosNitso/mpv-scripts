...
options={     --ALL OPTIONAL & CAN BE REMOVED.  (ARGUABLY A COMMA SHOULD LEAD EACH LINE. LUA FAILS WITHOUT THEM.)
    ...
    ytdl={    --YOUTUBE DOWNLOAD. PLACE ALONGSIDE main.lua.  LIST ALL POSSIBLE EXECUTABLE FILENAMES, IN PREFERRED ORDER. NO ";" ALLOWED.  CAN SET SMPLAYER Preferences→Network TO USE mpv INSTEAD OF auto. 
        "yt-dlp"      , --.exe
    ...
    options           = { 
        ...
        '  osd-level 0   ',  --PREVENTS SPURIOUS WARNINGS @load-script.
    },
    options_playback_start={ --@+.2s timeout.
        'osd-level 1',       --RETURN OSD.
        -- '   sid 1','secondary-sid 1',  --UNCOMMENT FOR SUBTITLE TRACK ID OVERRIDE.  BY TRIAL & ERROR, auto & 1 NEEDED BEFORE & AFTER lavfi-complex, FOR YOUTUBE.
    },
}
...
mp.register_event('playback-restart',function()mp.add_timeout(.2,playback_start)end)  --timeout REQUIRED TO SUPPRESS SPURIOUS WARNINGS, FROM SMPLAYER.
