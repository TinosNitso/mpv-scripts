...
options={     --ALL OPTIONAL & CAN BE REMOVED.
    ...
    title_duration =  5, --DEFAULT=0 SECONDS.  COUNTS FROM PLAYBACK-START.  title HAS NO TOGGLE.
...
function playback_restart()       --title WAITS FOR PLAYBACK START, OR IT'S PREMATURE.
    ...
    elseif o.sid then mp.command(('set sid %s;set secondary-sid %s'):format(o.sid,o.sid)) end  --OVERRIDE INTERFERENCE 
