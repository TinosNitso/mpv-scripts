...
----SAFETY INSPECTION: subprocess & run COMMANDS MAYBE UNSAFE, BUT seek frame-step stop quit af* vf* ARE ALL SAFE. LUA SCRIPTS SHOULD BE CHECKED FOR os.execute io.popen mp.command* utils.subprocess*
...
----FFmpeg version: 5.1.2 (MACOS). EACH SCRIPT PREPS & CONTROLS A GRAPH OF ffmpeg-filters. 
...
----MACOS:  /Applications/SMPlayer.app/Contents/MacOS/mpv ~/Desktop/mpv-scripts/TEST.MP4 --script=~/Desktop/mpv-scripts/autoloader.lua       EXACT MPV zsh TERMINAL COMMAND
