...
local options={ --ALL OPTIONAL & CAN BE REMOVED.
    scripts={"aspeed.lua",      --CLOCK & TITLE. ALSO AUDIO DEVICES SPEED RANDOMIZATION OVER SEVERAL HOURS (astats METRIC). CONVERTS MONO TO (RANDOMIZED) SURROUND SOUND. MY FAVOURITE OVERALL.
             "autocrop.lua",    --CROPS BLACK BARS BEFORE MASK, BUT AFTER SPECTRAL OVERLAY.     ON LINUX DON'T USE snap (BREAKS SMOOTH-crop-GRAPH).
...
----THESE SCRIPTS CAN PROBABLY BE RE-WRITTEN IN PYTHON (.py). EACH PREPS & CONTROLS A GRAPH OF ffmpeg-filters. LIKE HOW GIMP HAS SCM (SCHEME), NOTEPAD++ HAS SCINTILLA, MATH HAS OCTAVE/MATLAB, STATS HAS R, ELECTRUM HAS PYTHON, WINDOWS HAS AUTOHOTKEY (AHK), WEB HAS JAVASCRIPT, MPV HAS LUA.
